...
4. Unzip the file
5. Add a reference to *PrtgAPI.dll* to your project (*netstandard2.0*), or import the *PrtgAPI* module into PowerShell via `Import-Module C:\path\to\PrtgAPI`. Alternatively, you can run the included **PrtgAPI.cmd** or **PrtgAPI.sh** file to open a prompt and import the PrtgAPI module for you.
